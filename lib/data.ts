...
export const posts: Post[] = [
  {
    ...
    excerpt: 'Heathrow\'s Terminal 5 is an absolute monster of a hub, fast-moving and heavily reliant on tannoy announcements. Here is my personal playbook for breezing through it without missing a beat.',
...
T5 is notoriously famous for assigning gates at the absolute last second. I make sure to camp out within a perfect, direct line of sight to a Flight Information Display Screen (FIDS). Because individual gate adjustments are not broadcast visually over the main general seating areas, that screen is your absolute source of truth.`,
  },
  {
    ...
    excerpt: 'Gatwick\'s split-terminal layout relies heavily on an automated shuttle link. Here is how I keep my visual bearings intact without needing a single audio cue.',
...
If you book the Assisted Travel service, staff can guide you straight past security. But if you are travelling solo and independently like me, you can actually bypass the blinding maze of World Duty Free entirely. Just follow the clear structural signs to reach the Dedicated Assistance Seating zones. The best part? All key structural announcements are mirrored directly on the surrounding screens in these zones.
...
Both terminals use large, colour-coded overhead screens to stream passengers into the right security lanes. I just scan my barcode at the turnstiles and look for the bright green or red arrows to know which lane is ready for me. Once airside, the departure lounges are packed with dense digital matrixes. Since budget airlines love last-minute shuffles, I always grab a seat facing a master display screen so I can catch status changes instantly.`,
  },
  {
    ...
    date: 'July 2025',
    readTime: '6 min read',
    image: 'https://images.unsplash.com/photo-1542296332-2e4473fac563?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'Stansted funnels every single passenger through one massive room. Here is my strategy for tackling the crowds and navigating the satellite monorail trains safely.',
    body: `Stansted operates as one giant, continuous terminal building. While that simplifies orientation because you cannot get lost in the wrong building, it means the main departure hall gets incredibly loud and crowded. For a deaf traveller, it is a purely visual game of focus.
...
Budget carriers dominate Stansted, which means turnaround times are lightning-fast. I always sit right next to the gate-side digital displays because boarding phases scale up rapidly, and you will not get any extra visual buffers before they close the doors.`,
  },
  {
    ...
    date: 'August 2025',
    readTime: '5 min read',
    image: 'https://images.unsplash.com/photo-1495107334309-fcf20504a5ab?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'Béziers Airport is delightfully tiny. With just a single room making up the entire terminal, it completely eliminates the usual anxiety of tracking connections.',
...
**Walking the Tarmac**
Béziers does not have jet bridges, which I honestly prefer because it keeps everything out in the open. When boarding opens, the staff simply open a manual exit door leading straight out onto the tarmac. You just follow the physical queue layout painted on the asphalt directly to the aircraft stairways.
...
Because this regional hub handles only a couple of budget flights at any given time, the ambient noise is almost non-existent. It makes staying visually focused incredibly peaceful compared to the sensory overload of London airports.`,
  },
  {
    ...
    date: 'September 2025',
    readTime: '6 min read',
    image: 'https://images.unsplash.com/photo-1516483638261-f4dbaf036963?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'Menorca Airport organises its travel flow vertically across two floors. Here is how I navigate the layout and find quiet visual spaces during peak summer.',
...
If the main gates get too hectic, I highly recommend checking into the airside Tramuntana VIP lounge. It features its own standalone flight monitors in a completely calm environment, so I can relax, read, and track my gate assignments away from the crowded, noisy main walkways.`,
  },
  {
    ...
    date: 'October 2025',
    readTime: '7 min read',
    image: 'https://images.unsplash.com/photo-1530841377377-3ff06c0ca713?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'Palma Airport is absolutely immense, but its clever modular design makes it surprisingly visual-friendly if you prep your route.',
...
Because the gates are buried deep within separate architectural piers, the individual gate-front screens are your absolute source of truth. They display boarding status rows with brilliant clarity, shifting from "Scheduled" to "Boarding" using sharp, high-contrast text layouts that you can read from a distance.`,
  },
  {
    ...
    excerpt: 'Ibiza\'s single-terminal layout gets incredibly packed, making ambient noise sky-high. Here is how I navigate it independently using physical cues.',
...
A lot of budget airlines use the lower-level ground gates that lead to tarmac bus transfers. These gates can get a bit frantic, but they rely heavily on physical line lanes. I always look for the clearly printed zone lines marked on the floor to position myself visually for priority boarding.`,
  },
  {
    ...
    date: 'January 2026',
    readTime: '8 min read',
    image: 'https://images.unsplash.com/photo-1531058020387-3be344559be6?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'Spanning five massive terminal buildings, Houston Intercontinental is a giant. Here is my personal guide to conquering their airside and landside trains entirely by sight.',
    body: `Houston (IAH) is a massive American hub operating Terminals A, B, C, D, and E. Navigating between them means mastering two distinct transit train networks: the airside Skyway and the landside Subway. As someone who cannot rely on audio track announcements, I found their visual mapping systems brilliant.
...
Terminal D handles the bulk of the international flights and features expansive LED signage walls. My favourite design detail is at the check-in zones: they use brightly illuminated pillar lights that completely change colours based on which specific airline is operating at that desk, giving you an instant visual confirmation point.`,
  },
  {
    ...
    date: 'February 2026',
    readTime: '8 min read',
    image: 'https://images.unsplash.com/photo-1543716627-839b54c40519?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'JFK is a massive, decentralized network of completely separate terminal hubs. Here is how I use New York\'s digital accessibility tools to bridge the gap.',
...
If you use assistive listening devices, dedicated hearing loops compatible with the Telecoil/T setting are permanently installed at the main Information Centres across every single terminal block. You can find them at Terminal 1, Terminal 4 (Domestic and International), Terminal 5, Terminal 7, and Terminal 8 Information Centres.
...
The AirTrain platforms feature explicit, colour-coded light-up route maps. As the train moves along the tracks, glowing LED indicators change positions on the physical route board to show you exactly which terminal station you are pulling into. Plus, major hubs like Terminal 4 feature digital queue estimation graphics at security, displaying real-time visual line bars so you can choose the quickest path to the scanners.`,
  },
  {
    ...
    date: 'December 2025',
    readTime: '6 min read',
    image: 'https://images.unsplash.com/photo-1534008897995-27a23e859048?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'Valencia effortlessly blends historic and modern wings into a single continuous building. Here is how I navigate its exceptional linear floor tracking.',
...
The regional boarding wing uses a specific lower-level pier setup. Monitors are packed densely right at the top of the ramp entrance, allowing you to thoroughly verify your commuter flight details visually before you descend to the lower gates.`,
  },
  {
    ...
    date: 'May 2026',
    readTime: '5 min read',
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'As a frequent traveller, I love predictability. Premier Inn Preston North delivers a reliable, low-stress stay with a straightforward layout.',
...
The lobby features touch-screen automated check-in kiosks. The entire process is fully visual and text-driven, meaning you can bypass the main reception desk entirely if you prefer a quick, independent arrival. If you do check in with the team, the counter layout is low and completely open, providing excellent visibility and lighting for lip-reading or using speech-to-text apps.

**Setting Up My Room Safety (Crucial Tip!)**
Like most Premier Inn locations across the UK, this hotel does not have permanently installed flashing strobe fire alarms in standard bedrooms. Instead, they utilise portable Deaf Assist Alarms (usually Geemarc or Bellman kits). You must explicitly request this kit at reception during check-in. The kit comes in a compact case and includes a wireless receiver unit that sits on your bedside table, paired with a high-intensity vibrating pad (pillow shaker) that slides right underneath your pillow.

**Room Layout, Subtitles & Acoustics**
The rooms feature bright, well-placed overhead lighting and adjustable bedside lamps, making signing or lip-reading across the space effortless during evening hours. The rooms are fully carpeted and utilise heavy blackout curtains, which significantly deadens ambient hallway noise and echoing. The Freeview TVs have built-in subtitle functions accessible directly via a dedicated SUB or STTL button on the remote.`,
  },
  {
    ...
    date: 'June 2025',
    readTime: '6 min read',
    image: 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'Ikos Porto Petro offers a stunning luxury experience where their digital-first service model naturally eliminates typical audio barriers.',
...
All on-site a la carte restaurants utilise clear, highly detailed physical menus alongside digital versions via QR codes. The dining rooms feature expansive terrace seating with zero background music interference. Plus, beach and poolside service operates via a visual flag system or direct QR-code ordering from your sunbed, completely eliminating the need to flag anyone down vocally.`,
  },
  {
    ...
    date: 'April 2026',
    readTime: '5 min read',
    image: 'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=1600&q=80&auto=format&fit=crop',
    excerpt: 'Tucked right into Princess Street near Piccadilly, this boutique hotel pairs historic exterior charm with modern, visual-friendly interior convenience.',
    body: `Centrally located right in the heart of Manchester, this gorgeous boutique hotel pairs a stunning historic brick exterior with heavily updated digital convenience. While its vibrant city-centre location means higher ambient external noise outside, the internal room design provides an acoustically isolated, highly accessible refuge.
...
Accessible room options are outfitted with hardwired visual flashing fire alarms, but if you end up in a standard room like I did, the hotel provides portable alert systems upon request at check-in. These packs include a wireless transmitter and a heavy-duty vibrating pillow pad that triggers immediately upon sensing the frequencies of the main building alarm.`,
  },
  {
    ...
    excerpt: 'Château Capitoul seamlessly blends a historic French estate with modern luxury winery villas. Here is how I navigate its sprawling vineyard trails purely by sight.',
...
export const cities: CityListing[] = [
  {
    ...
    dining: [
      ...
      },
      {
        ...
        description: 'Features an open glass-walled kitchen workspace. Guests observe the chefs visually while enjoying an exceptionally bright, clear, and quiet room.',
        tags: ['Open Visual Kitchen', 'Pristine Acoustics', 'Elegant Setting'],
      },
      {
        name: 'Brat',
        type: 'Wood-Fired Basque',
        description: 'Rustic, warmly lit dining room with open kitchen theatre. Menu is printed daily and staff communicate comfortably via written notes.',
        tags: ['Warm Lighting', 'Open Kitchen', 'Written Ordering'],
      },
    ],
    selfGuided: [
      {
      ...
      },
      {
        ...
        description: 'Beautifully lit galleries with large-format typographic wall text, comprehensive printed guides, and interactive visual exhibits throughout.',
        tags: ['Large Typography', 'Interactive Exhibits', 'Printed Guides'],
      },
    ],
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1531218150217-54595bc2b934?w=1200&q=80&auto=format&fit=crop',
    dining: [
      {
        name: 'Uchi Houston',
        type: 'Modern Japanese',
        description: 'Intimate, warmly lit counter and table dining. Staff are accustomed to written ordering and the noise level is kept admirably low throughout service.',
        tags: ['Low Ambient Noise', 'Counter Seating', 'Written Ordering'],
      },
      {
        name: 'Caracol',
        type: 'Coastal Mexican',
        description: 'Bright, open-plan interior with excellent directional lighting. Wide table spacing makes visual conversation across the table entirely comfortable.',
        tags: ['Wide Table Spacing', 'Bright Interior', 'Attentive Staff'],
      },
    ],
    selfGuided: [
      {
        ...
        type: 'Art Museum',
        description: 'One of the largest art museums in the US. Gallery maps are detailed, wall text is thorough, and the layout is logical without audio guidance.',
        tags: ['Detailed Maps', 'Rich Wall Text', 'Self-Guided'],
      },
      {
        name: 'Buffalo Bayou Park',
        type: 'Urban Park Trail',
        description: 'A beautifully landscaped urban trail running through the heart of the city. Fully self-guided, outdoor, and entirely visual with excellent wayfinding markers.',
        tags: ['Outdoor Trail', 'Wayfinding Markers', 'Self-Paced'],
      },
    ],
  },
  {
    ...
    dining: [
      {
        name: 'Le Bernardin',
        type: 'Fine Seafood',
        description: 'An iconic, plush dining room with deeply coffered ceilings that effortlessly absorb ambient sound, paired with immaculate table service and clear lighting.',
        tags: ['Sound Absorbing Ceilings', 'Flawless Service', 'Bright Ambiance'],
      },
      {
        name: 'Atomix',
        type: 'Innovative Korean Counter',
        description: 'An intimate 14-seat basement counter where every dish is served with a gorgeous, descriptive card detailing its origins and philosophy.',
        tags: ['Descriptive Dish Cards', 'Counter Seating', 'Intimate Setting'],
      },
      {
        name: 'Don Angie',
        type: 'Italian-American',
        description: 'Warm, intimate room with close staff attention and beautifully managed acoustics. Written menus are clear and staff are responsive to non-verbal communication.',
        tags: ['Intimate Room', 'Warm Lighting', 'Quiet Acoustics'],
      },
    ],
    selfGuided: [
      {
        ...
        tags: ['Walkable Loop', 'Fully Visual', 'Free Admission'],
      },
      {
        name: 'The High Line',
    ...
    dining: [
      {
        ...
        type: 'Contemporary Valencian',
        description: 'Minimal, gallery-like dining room with exceptional natural light and wide table spacing. Staff communicate clearly and the room is remarkably quiet during service.',
        tags: ['Gallery Lighting', 'Wide Table Spacing', 'Quiet Room'],
      },
      {
        name: 'La Pepica',
        type: 'Traditional Paella',
        description: 'Open-air beachfront terrace with stunning natural light, ideal for visual communication. Printed menus are clear and staff are warm and gesture-friendly.',
        tags: ['Open Air Terrace', 'Natural Light', 'Gesture-Friendly Staff'],
      },
    ],
    selfGuided: [
      {
        ...
        description: 'One of the most visually spectacular architectural complexes in Europe. Entirely self-guided with clear wayfinding panels and printed maps.',
        tags: ['Iconic Architecture', 'Self-Guided', 'Printed Maps'],
      },
      {
        name: 'Mercado Central',
        type: 'Historic Market',
        description: 'One of the largest fresh produce markets in Europe. All vendors display goods visually with clear price boards. No audio interaction required to navigate.',
        tags: ['Visual Price Boards', 'No Audio Needed', 'Stunning Interior'],
      },
    ],
  },
  {
    city: 'Montpellier',
    country: 'France',
    image: 'https://images.unsplash.com/photo-1593359677879-a4bb92f4834c?w=1200&q=80&auto=format&fit=crop',
    dining: [
      {
        name: "Reflet d'Obione",
        type: 'Creative French',
        description: 'Beautifully intimate dining room with warm directional lighting and generous table spacing. Staff are attentive and happy to communicate via written notes.',
        tags: ['Intimate Room', 'Warm Lighting', 'Written Communication'],
      },
      {
        name: 'La Diligence',
        type: 'Traditional French Bistro',
        description: 'Set in a historic vaulted cellar with excellent acoustics. The stone walls naturally absorb sound, keeping the room calm and easy to navigate visually.',
        tags: ['Stone Vaulted Acoustics', 'Historic Setting', 'Clear Menus'],
      },
    ],
    selfGuided: [
      {
        ...
        description: 'One of the finest regional art museums in France. Comprehensive printed guides and detailed wall descriptions make audio tours entirely unnecessary.',
        tags: ['Printed Guides', 'Detailed Wall Text', 'Self-Guided'],
      },
      {
        name: "Place de la Comédie & Écusson Walk",
        type: 'Historic Centre Walk',
        description: 'The medieval old town is entirely self-paced and walkable. Downloadable heritage trail maps are available from the tourist office.',
        tags: ['Walkable Old Town', 'Downloadable Map', 'Self-Paced'],
      },
    ],
  },
  {
    city: 'Manchester',
    country: 'United Kingdom',
    image: 'https://images.unsplash.com/photo-1520277739336-7bf67edfa768?w=1200&q=80&auto=format&fit=crop',
    dining: [
      {
        name: 'Mana',
        type: 'Nordic-Influenced Tasting Menu',
        description: "Manchester's only Michelin-starred restaurant. Intimate, quiet room with focused spotlighting on each table, making visual communication across the table seamless.",
        tags: ['Michelin Star', 'Quiet Room', 'Table Spotlighting'],
      },
      {
        name: 'Elnecot',
        type: 'Modern British',
        description: 'Warm, industrial-chic space in Ancoats with excellent lighting and low ambient noise. Staff are attentive and the printed menu is clear and detailed.',
        tags: ['Low Ambient Noise', 'Clear Printed Menu', 'Attentive Staff'],
      },
    ],
    selfGuided: [
      {
        ...
        type: 'Art Museum',
        description: 'Free entry. Rich printed guides, large typographic wall text, and a clear logical gallery layout that requires no audio guidance whatsoever.',
        tags: ['Free Entry', 'Rich Wall Text', 'Clear Layout'],
      },
      {
        name: 'Northern Quarter Street Art Walk',
        type: 'Self-Guided Urban Walk',
        description: "An entirely visual, self-paced walk through Manchester's most creative neighbourhood. A downloadable map from VisitManchester covers all major murals.",
        tags: ['Downloadable Map', 'Fully Visual', 'Self-Paced'],
      },
    ],
  },
];
...
export const techItems: TechItem[] = [
  {
    ...
    name: 'Otter.ai',
    description: 'Real-time speech transcription with speaker identification. Works offline in areas with poor connectivity. Ideal for hotel check-in, guided tours, and restaurant interactions.',
    rating: 5,
  ...
  },
  {
    ...
    description: 'Accurate, low-latency transcription in 70+ languages. Free to use. Runs directly on Android without cloud processing. Highly reliable in transit environments.',
    rating: 5,
  ...
  },
  {
    ...
    name: 'Widex Moment',
    description: 'Waterproof hearing aids with IP68 rating. Bluetooth streaming from phone and TV. Rechargeable with 37-hour battery life. Travel-grade durability.',
    rating: 4,
  ...
  },
  {
    ...
    description: 'Vibrating travel alarm system with pillow shaker, bed shaker, and doorbell transmitter. Compact carry case. Works in any hotel room.',
    rating: 5,
  ...
  },
  {
    ...
    description: 'Directional microphone that transmits directly to compatible hearing aids or cochlear implants. Exceptional for one-on-one conversations and table discussions.',
    rating: 4,
  ...
  },
  {
    ...
    name: 'Hand Talk',
    description: 'Translates text and audio to sign language via animated avatar. Supports ASL and Libras. Useful for communicating with hearing children or new contacts.',
    rating: 4,
